...
<body>
	...
	<div class="container-fluid bg-primary m-0 p-0">
			...
			<div class="container-fluid ">
			    ...
			    <div class="collapse navbar-collapse " id="navbarSupportedContent">
			      ...
			      <form class="d-flex" action="Search_properties.php" method="get">
			        ...
			        <input type="submit" name="search_data_vehicle" value="Search" class="btn btn-outline-light">
			      </form>
			    </div>
			</div>
			         ...
			         <li class="nav-item dropdown  px-3">
			          ...
			          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<div class="float-right">
							...
							<a class="text-light mt-1 ms-0 pe-4 text-decoration-none float-end" href=""><i class="fa-solid fa-file-circle-plus fa-xl mt-3 mx-2"></i>Add properties</a>
		...
		<!-- third section -->
			...
			<h3 class="text-capitalize  text-primary"><span class="text-warning">G1<img src="image/uov_logo.png"></span>HOUSE STORE</h3>
			<h5 class="text-primary">The perfect home awaits <span class="text-warning">rent and relax!</span></h5>
		</div>
		<!-- fourth section -->
		...
		<!-- footer -->
		<div class="container-fluid bg-dark ">
			<footer class="bg-dark mt-5 fixed">
				<div class="row pt-5">
					<div class="col-4">
