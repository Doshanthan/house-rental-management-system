<?php 
 ...
 ?>
<div class="container">
	<h4>insert village</h4>
	<div class="row">
		<div class="col-5 align-item-center">
			<form action="" method="post" class=" mt-5">
				<div class="input-group">
					<span class="input-group-text bg-info" id="basic-addon1"><i class="fa-solid fa-receipt"></i></span>
					<input type="text" name="category_name" class="form-control" placeholder="insert village of property" aria-label="username" aria-describedby="basic-addon1">
					</div>
					<div class="input-group">
