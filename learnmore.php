<?php 
	...
	if(isset($_POST['book_submit'])){
		...
		$sql="select * from `houseproperties` where property_id='$property_id'";
		...
		$check_mail=$condition_check['owner_mail'];
...
<body>
	...
	<div class="jambotron">
	  	<div class="container">
			...
			<p class="load text-center"><?php echo $description ?></p>
			<hr class="my-4">
					...
					<?php  
										...
										$row=mysqli_fetch_assoc($res);
					      				if($row['status']=='Booked'){
					      					echo '<img class="mt-5 ps-auto mx-auto" src="picture/booked2.jpg" style="height:150px;width:150px">';
