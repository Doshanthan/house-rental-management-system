...
// function 01
	...
	function getproperties(){
		...
		if(isset($_GET['conform'])){
			...
			$sql="update `houseproperties` set status='Booked' where property_id='$property_id'";
		...
		if(isset($_GET['cancel_customer_booked'])){
			...
			$sql="update `houseproperties` set status='available' where property_id='$property_id'";
			$update_query=mysqli_query($con,$sql);
		...
		$sql="select * from `houseproperties` order by rand() limit 0,10";
						...
						<div class="card">
							...
							<div class="card-body text-capitalize">
								<div class="d-flex justify-content-between">
									<h5 class="card-title text-primary">'.$property_name.'</h5>
								...
								<div class="d-flex">
									<p class="pe-3"><img src="picture/table1.png">  '.$tables.'</p>
									<p class="ps-4"><img src="picture/bed.png">  '.$tables.'</p>
								</div>
	...
	function get_allproperties(){
		...
		$sql="select * from `houseproperties` order by rand()";
		if(!isset($_GET['category_id'])){
			if(!isset($_GET['brand_id'])){
				$result=mysqli_query($con,$sql);
					while($row=mysqli_fetch_assoc($result)){
				...
				function get_unique_category(){
					...
					$sql="select * from `houseproperties` where category_id=$category_id";
				...
				function get_unique_brand(){
					...
					$sql="select * from `houseproperties` where brand_id=$brand_id";
			...
			function search_properties(){
				...
				if(isset($_GET['search_data_vehicle'])){
					if(isset($_GET['search_data'])){
						...
						$sql="select * from `houseproperties` where property_name like '%$search_data%'";
